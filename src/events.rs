...
pub enum AppEvent {
    ...
    /// An explicit open gesture selected an image path owned by this server.
    /// The headless server validates and forwards it to the foreground client.
    ImagePreviewRequested { path: std::path::PathBuf },
