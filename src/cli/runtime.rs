use crate::api::schema::{
    ...
    WorkspaceRenameParams, WorkspaceSetTerminalLauncherParams, WorkspaceTarget,
...
pub(super) fn workspace_set_terminal_launcher(
    params: WorkspaceSetTerminalLauncherParams,
) -> std::io::Result<i32> {
    print_method_response(
        "cli:workspace:set-terminal-launcher",
